    ...
    {/* bg-gradient-to-br from-green-700 to-yellow-400 */}
			...
			<div className="relative flex flex-col justify-center items-center text-center">
				<div className=''>
					...
					<h1 className="font-russo text-7xl text-yellow-400">Under Construction</h1>
				</div>
        ...
        <button className='bg-red-500 border-none text-white rounded-md py-[10px] px-[25px] mt-9 hover:bg-yellow-400 hover:text-black'>Notify Me!</button>
