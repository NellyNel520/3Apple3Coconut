			...
			<div className="relative flex flex-col justify-center items-center text-center">
				<div className="">
					...
					<h1 className="font-russo text-7xl text-yellow-400">
						...
						<p className="w-[60%] font-prata text-lg">
							Our website is currently under construction as we're working hard
							to bring you an amazing online experience. We can't wait to share
							it with you! In the meantime, sign up below to stay in the loop
							and be the first to know about our updates. We Thank you for your
							patience!
						</p>
				...
				<div className="w-[60%] flex items-center justify-center mt-9 ">
					{!isFormOpen ? (
						<button
							onClick={openForm}
							className="bg-red-500 border-none text-white rounded-md py-[10px] px-[25px] hover:bg-yellow-400 hover:text-black"
						>
							Notify Me!
						</button>
					) : (
